...
export const formSchema = z.object({
    location: z.string().min(2, {message: "Must be 2 charcters or more"}).max(50),
    dates: z.object({
        from: z.date(),
        to: z.date(),
    }),
                    ...
                    <FormItem className="flex flex-col">
                        ...
                        <Popover>
                            <PopoverTrigger asChild>
                                <FormControl>
                                    <Button id="date" name="dates" variant={"outline"} className={cn("w-full lg:w-[300px] justify-start text-left font-normal", !field.value.from && "text-muted-foreground")}>
